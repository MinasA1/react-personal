...
const summary = 
  <div>
    <p>I am a Full Stack Software Engineer with experience on building distributed information systems and microservices.
    ...
    <p>At Holberton School I was able to sharpen my skills on C and learn the best practices of Object-Oriented Programming using Python and NodeJS.
      On top of that, I was able to design and apply an entire Web Infrastructure, identify bottlenecks, potential performance issues but also how to deal with them and automate the solution using Puppet, Python or Bash scripts.
      After finishing a group AirBnB clone project where we would inherit another teams's codebase, debug it and build on it.
      I started learning about React framework and developed a web application that data visualization seamless and very user friendly.</p>
    <p>Now I'm working on a personal project where I'm mixing the Block-Chain technology with Machine Learning and see what could this combined power achieve!</p>
  </div>
const data = [
